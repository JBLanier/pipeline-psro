...
from pomprl.rl.common.cloud_storage import connect_minio_client, upload_file, key_exists
...
from pomprl.util import datetime_str, with_updates
...
if __name__ == "__main__":
    ...
    if key_exists(minio_client=minio_client, bucket_name="stratego", object_name=POKER_ARCH1_MODEL_CONFIG_KEY):
