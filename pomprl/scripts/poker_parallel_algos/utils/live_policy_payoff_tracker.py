import ray
from pomprl.rl.common.cloud_storage import connect_minio_client
from population_server.worker import ConsoleManagerInterface
...
class LivePolicyPayoffTracker(object):
    def __init__(self,
        ...
        worker_id = f"live_pop_tracker_{worker_id}"
