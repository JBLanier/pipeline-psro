from population_server.lock_server.protobuf.lock_server_pb2 import LockRequest, LockConfirmation, LockWorkerPing, LockList
from population_server.lock_server.protobuf.lock_server_pb2_grpc import LockServerServicer, \
...
if __name__ == '__main__':
    ...
    lock_servicer = LockServerServicerImpl(minio_client=minio_client, bucket_name=BUCKET_NAME)
