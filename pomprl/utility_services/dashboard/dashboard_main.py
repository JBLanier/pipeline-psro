...
from population_server.dashboard.metanash import fictitious_play
from population_server.cloud_storage import connect_minio_client, MINIO_DEFAULT_SAVE_PATH
from population_server.payoff_table import PayoffTable
from population_server.utils import datetime_str, pretty_print
...
if __name__ == '__main__':
    ...
    def graph_fp_for_payoff_table(payoff_table: PayoffTable, save_path: str):
        ...
        fig = px.line_3d(alpha_rank_df, x="policy", y="generation", z="policy_selection_probs",
                         ...
                         title=f"Population Selection Probs (Fictitious Play) over Generations",
        ...
        while True:
            ...
            if new_payoff_table is None:
                ...
                if new_payoff_table_key != current_payoff_table_key:
                    ...
                    graph_fp_for_payoff_table(payoff_table=new_payoff_table,
    ...
    class DashboardHandler(SimpleHTTPRequestHandler):
        ...
        def send_stats(self):
            ...
            send_html = f"<h2>Manager on {stats['manager_hostname']}</h2>" \
                        f"<p>{pretty_print(stats['stats'])}</p>" \
                        f'<div>' \
