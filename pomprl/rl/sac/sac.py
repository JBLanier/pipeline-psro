...
from pomprl.rl.sac.sac_sync_replay_optimizer import SacSyncReplayOptimizer
from ray.rllib.agents.trainer import with_base_config
from pomprl.rl.common.custom_evals_trainer_mixin import perform_relevant_custom_evals, CustomEvaluationsTrainerMixin
from pomprl.rl.common.weights_utils_trainer_mixin import WeightsUtilsTrainerMixin
...
def make_optimizer(workers, config):
    ...
    try:
        only_sync_train_policies = config['multiagent']['policies_to_train']
    except KeyError:
        only_sync_train_policies = None

    return SacSyncReplayOptimizer(
        workers,
        ...
        workers_only_sync_policy_list=only_sync_train_policies,
        **config["optimizer"])
