...
export MANAGER_CONFIG_PATH="poker/${POKER_GAME_VERSION}_rectified_psro.yaml"
...
export DASHBOARD_PORT=2${POKER_GAME_PORT_PREFIX}405
export DASHBOARD_CONFIG_PATH=${POKER_GAME_VERSION}_rectified_psro.yaml
