from mprl.utility_services.real_time_payoff_tracker.protobuf.real_time_payoff_tracker_pb2 import PayoffTableKey, PolicyInfo, LivePolicyInfo, Confirmation, EvalMatchupResult
from mprl.utility_services.real_time_payoff_tracker.protobuf.real_time_payoff_tracker_pb2_grpc import RealTimePayoffTrackerServicer, \
...
from mprl.utility_services.cloud_storage import connect_storage_client, DEFAULT_LOCAL_SAVE_PATH, get_default_path_on_disk_for_minio_key, upload_file, post_key
...
if __name__ == '__main__':
    ...
    lock_servicer = RealTimePayoffTrackerServicerImpl(storage_client=storage_client, bucket_name=BUCKET_NAME)
