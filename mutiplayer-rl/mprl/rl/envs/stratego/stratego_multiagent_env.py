...
from stratego_env.game.stratego_procedural_impl import RecentMoves, SP, FULLY_OBSERVABLE_OBS_NUM_LAYERS, \
...
from stratego_env.game.util import get_random_initial_state_fn, get_random_human_init_fn
